...
df_n = pd.read_csv('Data/test_set/csv_all_test.csv')

df_a = pd.read_csv('Data/test_set/csv_all_test_ano.csv')
...
ax2.plot(df_f1.msssim, df_f1.fn,color="blue",marker="o", label= "False Positives")
ax2.set_ylabel("False predictions",color="blue",fontsize=14)
ax2.plot(df_f1.msssim, df_f1.fp,color="green",marker="o", label= "False Negatives")
